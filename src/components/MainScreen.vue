...
<template>
    <div class="main-screen">
        ...
        {{ response }}
        <div class="main-screen__screen">
            <PersonInfoScreen name="Alex" mail="ew.sorokina@mail,ru" src="https://avatars.githubusercontent.com/u/70776954?v=4" phone="89525867697" about="123"/>
        </div>
    </div>
